                    ...
                    <div className="footer-row-wrapper">
                            ...
                            <div className="footer-subscribe">
                                <div className="footer-subscribe-top">
                                    ...
                                    <p className="subscribe-desc">
                                        Well email you a voucher worth $10 off
                                        your first order over $50.
                                    </p>
                                </div>
                        ...
                        <div className="footer-contact-wrapper">
                            ...
                            <div className="footer-contact-bottom">
                                ...
                                <p className="privacy-text">
                                    <strong>Shopping App:</strong> Try our View
                                    in Your Room feature, manage registries and
                                    save payment info.
                                </p>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="footer-copyright">
                        <div className="site-copyright">
                            <p>
                                Copyright 2022 © E-Commerce Theme. All right
                                reserved. Powered by Emin Basbayan.
                            </p>
                        </div>
                        <a href="#">
