                ...
                <div className="container">
                    <div className="contact-titles">
                        ...
                        <p>
                            ...
                            viverra sem nec orci lacinia, in bibendum urna
                            mollis. Quisque nunc lacus, varius vel leo a,
                            pretium lobortis metus. Vivamus consectetur
                            consequat justo.
                        </p>
                    </div>
                    <div className="contact-elements">
                        <form className="contact-form">
                            ...
                            <button className="btn btn-sm form-button">
                                Send Message
                            </button>
                        </form>
                            ...
                            <div className="contact-info-item">
                                <div className="contact-info-texts">
                                    ...
                                    <p className="contact-street">
                                        Clotya Store Germany — 785 15h Street,
